...
entity verilator_c64_top is
    ...
    port (
        ...
        -- Direct bank-$00 BRAM probe for accurate text/screen RAM inspection.
        bram_probe_addr : in unsigned(15 downto 0);
...
architecture rtl of verilator_c64_top is
    ...
    signal bram_probe_data_s : unsigned(7 downto 0);
begin
    reset_n <= not reset;
    ...
    bram_probe_data <= std_logic_vector(bram_probe_data_s);
    ...
    dut : entity work.fpga64_sid_iec
        port map (
            ...
            c64rom_wr   => rom_wr,
            bram_probe_addr => bram_probe_addr,
            bram_probe_data => bram_probe_data_s,
            cass_motor  => open,
            cass_write  => open,
            cass_sense  => '1',
            cass_read   => '1'
