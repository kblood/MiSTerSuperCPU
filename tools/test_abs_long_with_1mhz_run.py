...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_abs_long_with_1mhz.prg')
PRG_REMOTE='/tmp/test_abs_long_with_1mhz.prg'
PRG_MGL='/tmp/load_test_abs_long_with_1mhz.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_abs_long_with_1mhz_run')
def run(c,cmd,t=20):
