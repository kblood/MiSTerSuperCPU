...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_post_reu_store.prg')
PRG_REMOTE='/tmp/test_post_reu_store.prg'
PRG_MGL='/tmp/load_test_post_reu_store_noreu.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_post_reu_store_noreu_run')
def run(c,cmd,t=20):
