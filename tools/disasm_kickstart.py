...
OPS = {
    ...
    0xC7:('CMP','dpi_long'), 0x47:('EOR','dpi_long'),
    0x27:('AND','dpi_long'), 0x67:('ADC','dpi_long'), 0xE7:('SBC','dpi_long'),
    0xD7:('CMP','dpi_long_y'), 0x57:('EOR','dpi_long_y'),
    0x37:('AND','dpi_long_y'), 0x77:('ADC','dpi_long_y'), 0xF7:('SBC','dpi_long_y'),
    ...
    0x06:('ASL','zp'), 0x16:('ASL','zp_x'),
    0x46:('LSR','zp'), 0x56:('LSR','zp_x'),
    0x26:('ROL','zp'), 0x36:('ROL','zp_x'),
    0x66:('ROR','zp'), 0x76:('ROR','zp_x'),
    0xE6:('INC','zp'), 0xF6:('INC','zp_x'),
    0xC6:('DEC','zp'), 0xD6:('DEC','zp_x'),
