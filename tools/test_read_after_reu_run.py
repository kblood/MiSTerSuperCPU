...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_read_after_reu.prg')
PRG_REMOTE='/tmp/test_read_after_reu.prg'
REU_MGL='/tmp/load_doom_reu_only.mgl'; PRG_MGL='/tmp/load_test_read_after_reu.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_read_after_reu_run')
def run(c,cmd,t=20):
