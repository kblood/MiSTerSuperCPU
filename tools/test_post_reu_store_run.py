...
REU_MGL='/tmp/load_doom_reu_only.mgl'; PRG_MGL='/tmp/load_test_post_reu_store.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_post_reu_store_run')
def run(c,cmd,t=20):
