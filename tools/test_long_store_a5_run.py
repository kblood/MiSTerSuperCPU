...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_long_store_a5.prg')
PRG_REMOTE='/tmp/test_long_store_a5.prg'
PRG_MGL='/tmp/load_test_long_store_a5.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_long_store_a5_run')
def run(c,cmd,t=20):
