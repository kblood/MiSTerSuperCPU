...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_long_store_only.prg')
PRG_REMOTE='/tmp/test_long_store_only.prg'
REU_MGL='/tmp/load_doom_reu_only.mgl'; PRG_MGL='/tmp/load_test_long_store_only.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_long_store_only_run')
def run(c,cmd,t=20):
