...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_long_store_3f.prg')
PRG_REMOTE='/tmp/test_long_store_3f.prg'
PRG_MGL='/tmp/load_test_long_store_3f.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_long_store_3f_run')
def run(c,cmd,t=20):
