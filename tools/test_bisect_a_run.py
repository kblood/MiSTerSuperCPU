...
PRG_LOCAL=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_bisect_a.prg')
PRG_REMOTE='/tmp/test_bisect_a.prg'
REU_MGL='/tmp/load_doom_reu_only.mgl'; PRG_MGL='/tmp/load_test_bisect_a.mgl'
OUT=os.path.join(os.path.dirname(os.path.abspath(__file__)),'test_bisect_a_run')
def run(c,cmd,t=20):
